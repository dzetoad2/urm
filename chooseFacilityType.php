        ...
        <body>
            ...
            if (defined('DEBUG')) {
                ...
                if (isset($userFacilityId))
                    echo " userFacilityId （this is all we require to do edits back at myFacilities.php) posted:  " . $userFacilityId . '<br/>';
                if (isset($customFacilityId))
                    echo " customFacilityId （this is all we require to do edits back at myFacilities.php) posted:  " . $customFacilityId . '<br/>';
